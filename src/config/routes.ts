...
export const routes: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "reports", lazy: async () => ({ Component: (await import("@/pages/monitoring")).ReportsPage }), children: [{ path: "group", lazy: async () => ({ Component: (await import("@/pages/monitoring")).GroupReportsPage }) }, { path: ":id", lazy: async () => ({ Component: (await import("@/pages/monitoring")).ReportDetailPage }) }] },
      ...
      { path: "operations", children: [
        ...
        { path: "teams", lazy: async () => { const [dashboard, monitoring] = await Promise.all([import("@/pages/dashboard"), import("@/pages/monitoring")]); return { Component: monitoring.OperationsTeamsPage, loader: dashboard.loader }; }, children: [{ path: ":id", lazy: async () => ({ Component: (await import("@/pages/monitoring")).OperationsTeamDetailPage }) }] },
        { path: "equipment", lazy: async () => { const [dashboard, monitoring] = await Promise.all([import("@/pages/dashboard"), import("@/pages/monitoring")]); return { Component: monitoring.OperationsEquipmentPage, loader: dashboard.loader }; }, children: [{ path: ":id", lazy: async () => ({ Component: (await import("@/pages/monitoring")).OperationsEquipmentDetailPage }) }] },
        { path: "assignments", lazy: async () => { const [dashboard, monitoring] = await Promise.all([import("@/pages/dashboard"), import("@/pages/monitoring")]); return { Component: monitoring.OperationsAssignmentsPage, loader: dashboard.loader }; }, children: [{ path: ":id", lazy: async () => ({ Component: (await import("@/pages/monitoring")).OperationsAssignmentDetailPage }) }] },
        { path: "access-water", lazy: async () => { const [dashboard, monitoring] = await Promise.all([import("@/pages/dashboard"), import("@/pages/monitoring")]); return { Component: monitoring.OperationsAccessWaterPage, loader: dashboard.loader }; }, children: [{ path: ":id", lazy: async () => ({ Component: (await import("@/pages/monitoring")).OperationsFeatureDetailPage }) }] },
      ] },
