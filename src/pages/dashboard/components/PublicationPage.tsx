...
export function usePublication(user: DashboardUser, slug: string | null) {
  return useQuery({ queryKey: ["dashboard", user.id, user.role, "publication", slug], enabled: !!slug, gcTime: 0, retry: false, queryFn: async ({ signal }) => {
