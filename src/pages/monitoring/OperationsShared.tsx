...
export function AssignmentAction({ user, item, refresh, onDraft, onSaved }: { user: DashboardUser; item: MonitoringOperations["assignments"][number]; refresh: () => Promise<void>; onDraft?: (state: { dirty: boolean; pending: boolean }) => void; onSaved?: () => void }) {
