...
export default function OperationsPage() {
  return <>
    <PageIntro eyebrow="Operations" title="Choose an operational workspace." description="Open one resource area at a time to manage teams, equipment, assignments, or verified access and water conditions." />
